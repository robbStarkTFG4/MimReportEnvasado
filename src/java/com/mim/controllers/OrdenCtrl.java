...
@Named("orden")
@SessionScoped
public class OrdenCtrl implements Serializable {

    private List<Orden> ordenes;
    private List<Orden> ordenesMejoras;
    ...
    public void init() {
        ...
        //RequestContext.getCurrentInstance().execute("window.alert('linea 30')");
        System.out.println("holaaaa!!!!");
        ordenes = ordenFacade.findAll("linea 10");
        currentLine = "linea 10".toUpperCase();
        ordenesMejoras = ordenFacade.findAllImprovements("linea 10");
    }
    ...
    public void execute() {
        ...
        if (!uri.equals("/envasado/faces/index.xhtml")) {
    ...
    private void performQueries() {
        ...
        ordenes = ordenFacade.findAll(currentLine);
        ordenesMejoras = ordenFacade.findAllImprovements(currentLine);
        RequestContext.getCurrentInstance().update("orderForm");
    }

    public void onRowSelect(SelectEvent event) {
        current = (Orden) event.getObject();
        ordenId=String.valueOf(current.getIdorden());
    ...
    public String buildReport() {
        ...
        //response.setHeader("Content-disposition", "inline=filename=file.pdf");
            ...
            System.out.println("lugar equipo: " + current.getEquipoIdequipo().getLugarIdlugar().getNombre());
            // step 1
    ...
    public List<Orden> getOrdenesMejoras() {
        return ordenesMejoras;
    }

    public void setOrdenesMejoras(List<Orden> ordenesMejoras) {
        this.ordenesMejoras = ordenesMejoras;
    }
    ...
    public void setDetallesList(List<HistorialDetalles> detallesList) {
